 ...
 */
 ...
 export default class CanvasDraggle {
     ...
     public constructor(diagram: any) {
         ...
         this.canvasPosition = diagram.state.canvasPosition || {
             left: 0,
             top: 0
         };
     ...
     public init() {
         ...
         this.canvas = this.diagram.canvas.current;
     ...
     private mousewheel =(event: any)=> {
         ...
         this.diagram.state.canvasZoom += detail * step;
         this.setZoom(this.diagram.state.canvasZoom);
     ...
     public setZoom(zoom: number) {
         ...
         this.diagram.setState({
             canvasPosition,
             canvasZoom: this.zoom = zoom
         });
         
         this.diagram.state.instance.setZoom(zoom);
     }
