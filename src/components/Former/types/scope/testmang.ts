...
const functionconfig = {
    ...
    Array: ["from:n:GA", "copyWithin:2:GQ", "findIndex:1:GQ", "find:1:GQ", "findLast:1:GQ","findLastIndex:1:GQ","includes:1:GQ", "sort:1:FUN"],
    Object: ["keys:1:GP1", "assign:n:GP1", "entries:1:GP1", "fromEntries:n:GP2"]
}
